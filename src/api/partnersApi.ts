...
export const mijozKompaniyalariApi = {
  ...
  yaratish: async (data: MijozKompaniyasiMalumoti) =>
    apiData(
      (
        await apiClient.post<MijozKompaniyasi | ApiEnvelope<MijozKompaniyasi>>(
          "/partners/client-companies",
          data
        )
      ).data
  ...
  yangilash: async (id: string, data: Partial<MijozKompaniyasiMalumoti>) =>
    apiData(
      (
        await apiClient.patch<MijozKompaniyasi | ApiEnvelope<MijozKompaniyasi>>(
          `/partners/client-companies/${id}`,
          data
        )
      ).data
...
export const yetkazibBeruvchilarApi = {
  ...
  yaratish: async (data: YetkazibBeruvchiMalumoti) =>
    apiData(
      (await apiClient.post<YetkazibBeruvchi | ApiEnvelope<YetkazibBeruvchi>>("/partners/suppliers", data))
        .data
    ),
  yangilash: async (id: string, data: Partial<YetkazibBeruvchiMalumoti>) =>
    apiData(
      (
        await apiClient.patch<YetkazibBeruvchi | ApiEnvelope<YetkazibBeruvchi>>(
