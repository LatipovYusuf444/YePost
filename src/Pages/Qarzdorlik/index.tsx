...
export default function Qarzdorliklar({ sotuvlar, onSotuvniOchish, onYangilash }: Props) {
  ...
  return <section className="overflow-hidden rounded-[32px] border border-orange-100 bg-white shadow-[0_24px_70px_rgba(37,99,235,.08)]">
    <div className="bg-gradient-to-br from-[#F8FAFC] via-white to-orange-50/60 px-6 py-7 sm:px-8">
    ...
    <div className="flex flex-col gap-3 border-y border-orange-100 px-6 py-5 lg:flex-row lg:justify-between sm:px-8">
      <label className="flex h-11 w-full items-center gap-3 rounded-2xl border border-orange-100 bg-[#F8FAFC] px-4 focus-within:border-orange-300 lg:max-w-lg">
